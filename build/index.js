...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!./CarouselStyles.css", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!./CarouselStyles.css");
...
var _bind = __webpack_require__(4);
...
var CarouselItem = function (_React$Component) {
  ...
  function CarouselItem(props) {
    ...
    _this.centerCard = _this.centerCard.bind(_this);
    return _this;
  }
  ...
  _createClass(CarouselItem, [{
    ...
    value: function componentDidMount() {
      this.setState({
        centerVal: _reactDom2.default.findDOMNode(this).getBoundingClientRect().left + _reactDom2.default.findDOMNode(this).getBoundingClientRect().width / 2
      });
    }
  }, {
    key: 'centerCard',
    value: function centerCard() {
    ...
    value: function render() {
      var divClasses = (0, _bind2.default)({
        'carousel__cell': true,
        'carousel__cell--selected': this.props.selected
      });

      return _react2.default.createElement('div', { className: divClasses, onClick: this.centerCard });
    }
  }]);
...
var Carousel = function (_React$Component2) {
  ...
  function Carousel(props) {
    ...
    _this2.getCenterCoordinate = _this2.getCenterCoordinate.bind(_this2);
    _this2.translateCarousel = _this2.translateCarousel.bind(_this2);
    _this2.toggleButtons = _this2.toggleButtons.bind(_this2);
    _this2.renderCarouselItems = _this2.renderCarouselItems.bind(_this2);
    _this2.renderCarouselItem = _this2.renderCarouselItem.bind(_this2);
    return _this2;
  }

  _createClass(Carousel, [{
    key: 'getCenterCoordinate',
    value: function getCenterCoordinate() {
      return _reactDom2.default.findDOMNode(this).getBoundingClientRect().left + _reactDom2.default.findDOMNode(this).getBoundingClientRect().width / 2;
    }
  }, {
    key: 'translateCarousel',
    value: function translateCarousel(childCenterCoordinate) {
      var transformXVal = childCenterCoordinate - this.state.centerVal ? this.state.centerVal - childCenterCoordinate : -1 * (childCenterCoordinate - this.state.centerVal);
    ...
    value: function componentDidMount() {
      ...
      var selectedButtons = [true];

      if (this.props.numCards !== undefined) {
        for (var i = 0; i < this.props.numCards - 1; i += 1) {
    ...
    key: 'toggleButtons',
    value: function toggleButtons(clickedIdx) {
      var selectedButtons = [];

      // only the clicked button and the true button should toggle its state
      for (var i = 0; i < this.state.selectedButtons.length; i += 1) {
        var isSelected = i === clickedIdx;
    ...
    value: function renderCarouselItem(isSelected, idx) {
      return _react2.default.createElement(CarouselItem, { key: idx, idx: idx, selected: isSelected, translateCarousel: this.translateCarousel, toggleButtons: this.toggleButtons });
    }
  }, {
    ...
    value: function renderCarouselItems() {
      ...
      return this.state.selectedButtons.map(function (selected, idx) {
        return _this3.renderCarouselItem(selected, idx);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var carouselTranslateStyle = {
        transform: 'translate(' + this.state.transformX + 'px, 0px)'
      };

      return _react2.default.createElement(
        'div',
        { className: 'carousel', style: carouselTranslateStyle },
...
var ReflexNewCarousel = function (_React$Component3) {
  _inherits(ReflexNewCarousel, _React$Component3);

  function ReflexNewCarousel() {
    _classCallCheck(this, ReflexNewCarousel);

    return _possibleConstructorReturn(this, (ReflexNewCarousel.__proto__ || Object.getPrototypeOf(ReflexNewCarousel)).apply(this, arguments));
  }

  _createClass(ReflexNewCarousel, [{
    key: 'render',
  ...
  return ReflexNewCarousel;
}(_react2.default.Component);

exports.default = ReflexNewCarousel;
...
var tracking = __webpack_require__(18);
